 ...
 */
@interface OMIDMegabraincoAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDMegabraincoAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDMegabraincoAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDMegabraincoAdSessionContext *)context
