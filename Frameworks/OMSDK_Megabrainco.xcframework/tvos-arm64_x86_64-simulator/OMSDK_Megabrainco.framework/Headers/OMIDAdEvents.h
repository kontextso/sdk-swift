 ...
 */
@interface OMIDMegabraincoAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDMegabraincoAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDMegabraincoVASTProperties *_Nonnull)vastProperties
