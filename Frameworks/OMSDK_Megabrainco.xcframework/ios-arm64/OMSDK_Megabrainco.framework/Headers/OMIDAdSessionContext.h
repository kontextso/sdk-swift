 ...
 */
@interface OMIDMegabraincoAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDMegabraincoPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDMegabraincoPartner *)partner
                               ...
                               resources:(NSArray<OMIDMegabraincoVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
...
- (nullable instancetype)initWithPartner:(OMIDMegabraincoPartner *)partner
                              ...
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                           universalAdID:(nullable OMIDMegabraincoUniversalAdID *)universalAdID
                                   error:(NSError *_Nullable *_Nullable)error;
